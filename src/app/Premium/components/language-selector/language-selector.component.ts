...
import { LanguageService, SUPPORTED_LANGUAGES, AppLanguage } from '../../services/language.service';
import { prefersReducedMotion } from '../../animations/motion-utils';
...
@Component({
  ...
  animations: [
    // Panel opens with a fade + scale from the top, a soft shadow and rounded
    // corners (CSS); each menu item then animates in one-by-one.
    trigger('langPanel', [
      transition(':enter', [
